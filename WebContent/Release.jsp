...
<body>
<article class="main">
	<form action="work.do?action=release" method="post" id="frm">
		<section>
			<table width="80%"  align="center"  >
			<caption class="caption">출고 하기</caption>
			<tbody id="content">
				<tr align="center"><td>제품 선택</td></tr>
				<tr align="center"><td><select id="product" name="rid">
		...
		<section class="link">
			...
			<tr><td align="center">
				...
				<a href="work.do?action=waitinglist">입고하기</a>
